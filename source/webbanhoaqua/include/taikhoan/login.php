	...
	if(isset($_POST['hanhdong']) && $_POST['hanhdong']=="tquat"){
		...
		// $pass=$_POST["txtpass"];
			...
			$strSQL="SELECT *  FROM khach_hang WHERE ten_dn = '$tendangnhap' AND mat_khau = '$pass'";
				$khachhang=$conn->query($strSQL);
				$rowDN=$khachhang->fetch_array();
	}
?>
<table width="220" border="0" cellpadding="0" cellspacing="0">
	...
	<form action="" method="post" name="dangky">
		...
		<input type="hidden" name="makhachhang" value="<?php if(isset($_SESSION['makhachhang'])){echo $_SESSION['makhachhang'];}?>" />
	</form>
	<script>
